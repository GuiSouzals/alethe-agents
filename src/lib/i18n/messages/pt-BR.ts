...
export const ptBR: Record<MessageKey, string> = {
  ...
  'widget.cursorSignInHint': 'rode agent login — o consumo fica no dashboard do Cursor, não aqui',
  ...
  // Lord F3: Rótulos neutros de processo; nenhum deles significa aprovação.
  'orchestration.activity': 'Atividade de orquestração',
  'orchestration.mode.solo': 'solo',
  'orchestration.mode.team': 'time',
  'orchestration.origin': 'Origem: {origin}',
  'orchestration.state.requested': 'despachado',
  'orchestration.state.accepted': 'pedido recebido',
  'orchestration.state.terminalCreated': 'terminal criado',
  'orchestration.state.running': 'em execução',
  'orchestration.state.toolRunning': 'ferramenta em execução',
  'orchestration.state.toolFinished': 'ferramenta terminou',
  'orchestration.state.ended': 'terminou',
  'orchestration.state.failed': 'falhou',
  'orchestration.state.revoked': 'revogado',
  'orchestration.focusParent': 'Pai',
  'orchestration.focusChild': 'Filho',
