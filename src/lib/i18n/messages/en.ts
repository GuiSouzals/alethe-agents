...
export const en = {
  ...
  // Lord F3: Neutral orchestration process labels; none implies approval.
  'orchestration.activity': 'Orchestration activity',
  'orchestration.mode.solo': 'solo',
  'orchestration.mode.team': 'team',
  'orchestration.origin': 'Origin: {origin}',
  'orchestration.state.requested': 'dispatched',
  'orchestration.state.accepted': 'request accepted',
  'orchestration.state.terminalCreated': 'terminal created',
  'orchestration.state.running': 'running',
  'orchestration.state.toolRunning': 'tool running',
  'orchestration.state.toolFinished': 'tool finished',
  'orchestration.state.ended': 'ended',
  'orchestration.state.failed': 'failed',
  'orchestration.state.revoked': 'revoked',
  'orchestration.focusParent': 'Parent',
  'orchestration.focusChild': 'Child',
  'orchestration.internal.readOnly': 'Internal subagent — read-only view',
